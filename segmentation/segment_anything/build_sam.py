...
def build_sam_vit_h(image_size=1024, checkpoint=None):
    ...
    return _build_sam(image_size, image_encoder, checkpoint)


build_sam = build_sam_vit_h


def build_sam_vit_l(image_size=1024, checkpoint=None):
    image_encoder = _build_sam_encoder(
        image_size,
...
def build_sam_vit_b(image_size=1024, checkpoint=None):
    image_encoder = _build_sam_encoder(
        image_size,
